...
import { ArrowLeft, Plus, X, Upload, Video, FileText, Sparkles, LogOut } from 'lucide-react';
...
const CreateCourse = ({ user, onLogout }) => {
  ...
  const [videos, setVideos] = useState([{ id: 1, title: '', youtubeUrl: '', duration: '' }]);
  const [thumbnail, setThumbnail] = useState(null);

  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Course created:', { ...formData, videos });
    alert('Course created successfully! (Demo only)');
    navigate(-1);
  };
